...
<div id="flotcontainer" style="height:200px; width:100%;"></div>
    ...
    */
    ...
    loadScript("/Content/smart/js/plugin/flot/jquery.flot.cust.min.js", loadFlotResize);

    function loadFlotResize() {
    loadScript("/Content/smart/js/plugin/flot/jquery.flot.resize.min.js", loadFlotToolTip);
    }

    function loadFlotToolTip() {
    loadScript("/Content/smart/js/plugin/flot/jquery.flot.tooltip.min.js", generateRandomFlot);
    }
